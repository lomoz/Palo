package de.app.classic.palo.Fragments;
...
import de.app.classic.palo.CurrLocUpdate;
import de.app.classic.palo.GetFromDatabase.GetEncodedImageFromDB;
import de.app.classic.palo.GetFromDatabase.GetStatusFromDB;
import de.app.classic.palo.GetFromDatabase.GetUsernameFromDB;
import de.app.classic.palo.MarkerColorJSON;
import de.app.classic.palo.MyApplicationContext;
import de.app.classic.palo.OldStatus;
import de.app.classic.palo.OnClickSendToDB;
import de.app.classic.palo.ProfilActivity;
import de.app.classic.palo.SendEncodedImageToDB;
import de.app.classic.palo.UsernameJSON;
import de.app.classic.palo.sendStatusToDB;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int permissionCheck = ContextCompat.checkSelfPermission(MyApplicationContext.getAppContext(), Manifest.permission.CAMERA);
        if (permissionCheck == PackageManager.PERMISSION_DENIED) {
            RequestRuntimePermission();
        }

        TelephonyManager tManager = (TelephonyManager) getActivity().getSystemService(Context.TELEPHONY_SERVICE);
        if (ActivityCompat.checkSelfPermission(MyApplicationContext.getAppContext(), Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
